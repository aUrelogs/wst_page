    ...
    <img src="images/logo.png" class="logo" style="width: 100px;">
        ...
        <nav>
            <ul class ="nav_links">
                ...
                <img src="images/userlogoo.png" class="logo" style="width: 20px;"> Welcome | <a href = index.php style="font-family: Century Gothic; font-weight: 500; font-size: 20px; color: #6b3e26; text-decoration: none; cursor: pointer;">Log out</a></li>
            </ul>
        </nav>
    </header>
<?php
